...
**neobb** is a community-driven bulletin board focused on discussions around the _Simple Web_, _Indie Web_, and similar topics. Currently developed by @smaudd, contributions—whether code or ideas—are always welcome.
